      ...
      <html>
        ...
        <body>
          <div class="receipt-container">
            ...
            <div class="footer">
              This is a computer-generated receipt and is NOT valid for claiming tax benefits. For an official donation receipt, please WhatsApp a copy of this receipt + a screenshot of your payment to <a href="https://wa.me/+919625460069" target=" className="text-black"> +91 9625460069.</className=> </a>{" "} The official receipt will be shared after verification.
            </div>
          </div>
        </body>
      </html>
            ...
            <Card className="overflow-hidden border-none shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  ...
                  so that he can help run our first community kitchen in a more
                  skilled and stable role.
                </p>
                <h4 className="text-2xl font-bold text-orange-600">
                  Goal: ₹60,000
                </h4>

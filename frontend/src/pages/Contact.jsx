            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-xs mt-1">Mon-Sat: 9AM - 6PM</p>
                </CardContent>
              </Card>
          ...
          <Card className="border-none shadow-2xl overflow-hidden">
            <div className="h-96 bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm mt-2">{contactInfo.address}</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-orange-100 mb-8">
              Join our community of volunteers and help us feed those in need
            </p>
